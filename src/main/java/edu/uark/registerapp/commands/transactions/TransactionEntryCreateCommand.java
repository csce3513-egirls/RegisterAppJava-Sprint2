...
public class TransactionEntryCreateCommand implements ResultCommandInterface<TransactionEntry> {
    ...
    //TODO: CLEAN UP THIS THING, MOSTLY TALKING ABOUT COMMENTS
    //also please NEVER try to call getId() below this comment, it will break the ajax response and you will have a horrible day. 
    //Id will be generated each time anyway
